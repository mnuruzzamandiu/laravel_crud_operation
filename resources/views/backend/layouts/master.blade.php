...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Apr 2023 16:11:34 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link href="{{ asset('contents/backend')}}/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="{{ asset('contents/backend')}}/assets/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">
	<link rel="stylesheet" href="../../cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.6.4/nouislider.min.css">
	<link href="{{ asset('contents/backend')}}/assets/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="{{ asset('contents/backend')}}/assets/vendor/jvmap/jquery-jvectormap.css" rel="stylesheet">
	<link href="../../cdn.datatables.net/buttons/1.6.4/css/buttons.dataTables.min.css" rel="stylesheet">
	<link href="{{ asset('contents/backend')}}/assets/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
	
	<!-- tagify-css -->
	<link href="{{ asset('contents/backend')}}/assets/vendor/tagify/dist/tagify.css" rel="stylesheet">
	
	<!-- Style css -->
    <link href="{{ asset('contents/backend')}}/assets/css/style.css" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('contents/backend')}}/assets/vendor/global/global.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/chart.js/Chart.bundle.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/apexchart/apexchart.js"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{ asset('contents/backend')}}/assets/js/dashboard/dashboard-1.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/draggable/draggable.js"></script>
	
	
	<!-- tagify -->
	<script src="{{ asset('contents/backend')}}/assets/vendor/tagify/dist/tagify.js"></script>
	 
	<script src="{{ asset('contents/backend')}}/assets/vendor/datatables/js/jquery.dataTables.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/datatables/js/dataTables.buttons.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/datatables/js/buttons.html5.min.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/datatables/js/jszip.min.js"></script>
	<script src="j{{ asset('contents/backend')}}/assets/s/plugins-init/datatables.init.js"></script>
   
	<!-- Apex Chart -->
	
	<script src="{{ asset('contents/backend')}}/assets/vendor/bootstrap-datetimepicker/js/moment.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
	

	<!-- Vectormap -->
    <script src="{{ asset('contents/backend')}}/assets/vendor/jqvmap/js/jquery.vmap.min.js"></script>
    <script src="{{ asset('contents/backend')}}/assets/vendor/jqvmap/js/jquery.vmap.world.js"></script>
    <script src="{{ asset('contents/backend')}}/assets/vendor/jqvmap/js/jquery.vmap.usa.js"></script>
    <script src="{{ asset('contents/backend')}}/assets/js/custom.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/js/deznav-init.js"></script>
	<script src="{{ asset('contents/backend')}}/assets/js/demo.js"></script>
    <script src="{{ asset('contents/backend')}}/assets/js/styleSwitcher.js"></script>
	
	
	
</body>

<!-- Mirrored from w3crm.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Apr 2023 16:12:08 GMT -->
</html>