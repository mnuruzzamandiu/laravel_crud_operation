...
function switcherClick() {
  ...
  let defaultTransparentHeaderVar =  defaultTransparentHeaderBtn.addEventListener(
    "click",
    () => {
...
function horizontalClickFn() {
  ...
  if (localStorage.velvetMenu != "dark") {
    html.setAttribute("data-menu-styles", "light");
  }
  checkOptions();
  checkHoriMenu();
...
function ResetAllFn() {
  ...
  document.querySelector("#switcher-header-fixed").checked = false;
